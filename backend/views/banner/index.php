    ...
    $gridColumns = [
        ...
        [
            ...
            'value' => function ($model) {
                return $model->photo ? Html::img(Url::toRoute('banner/file-banner?id=' . $model->id), ['style' => 'width:500px; height:200px']) : Null;
            },
            'format' => 'html'
        ],
        [
            'contentOptions' => ['class' => 'action-column nowrap text-left', 'style' => 'width:300px;'],
            'header' => 'Action',
